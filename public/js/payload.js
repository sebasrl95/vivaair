...
var PayloadPanel = (function() {
  ...
  function payloadUpdateSetup() {
    ...
    ApiChatVivaAir.setResponsePayload = function(newPayload) {
  ...
  function displayPayload(typeValue) {
    ...
    if (isRequest !== null) {
      ...
      if (ApiChatVivaAir.getRequestPayload() || ApiChatVivaAir.getResponsePayload()) {
  ...
  function buildPayloadDomElement(isRequest) {
    var payloadPrettyString = jsonPrettyPrint(isRequest
            ? ApiChatVivaAir.getRequestPayload() : ApiChatVivaAir.getResponsePayload());
